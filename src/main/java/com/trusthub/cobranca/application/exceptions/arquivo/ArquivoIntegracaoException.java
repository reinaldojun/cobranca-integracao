 ...
 *  @author alan.franco
 */
public class ArquivoIntegracaoException extends TrustHubExternalIntegrationException {

	private static final long serialVersionUID = 1L;

	public ArquivoIntegracaoException(String msg, TrustHubError trustHubError, HttpStatus httpStatus,
			Throwable cause) {
		super(msg, trustHubError, httpStatus, cause);
	}

	public ArquivoIntegracaoException(String msg, TrustHubError trustHubError,
			HttpStatus httpStatus) {
		super(msg, trustHubError, httpStatus);
	}

	public ArquivoIntegracaoException(String msg, TrustHubError trustHubError, Throwable cause) {
